...
//			Lazarus.Options.checkForUpdates();
      ...
      $('*[onenter]').on('keydown', function(evt){
        var KEY_ENTER = 13;
      ...
      $('*[onescape]').on('keydown', function(evt){
        var KEY_ESCAPE = 27;
        if (evt.keyCode == KEY_ESCAPE){
          ...
          $('#'+ id).click();
			...
			$("#database-rebuild").on("click", function(){
        Lazarus.msg("options.rebuildingDatabase", "loading");
				Lazarus.callBackground("Lazarus.Background.rebuildDatabase", [function(){
			...
			$('#unittests-run').on("click", function(){
      ...
      $('#worker-aes-test').on('click', function(){
  ...
  initDisabledDomains: function(){
    ...
    $('#disabled-domains').on("change",function(){
  ...
  initExpireForms: function(){
    ...
    $('#expire-forms-interval, #expire-forms-unit').on( 'input change', function(){
  ...
  initSecurityTab: function(){
    ...
    $('#encryption-checkbox').on("change",function(){
      if (this.checked){
    ...
    $('#encryption-password-change').on("click",function(){
    ...
    $('#encryption-password-save, #encryption-password-remove').on("click", function(){
    ...
    $('#encryption-password-reset').on("click", function(){
    ...
    $('#encryption-password-cancel').on("click", function(){
  ...
  initSyncTab: function(){
    ...
    $('#sync-login-warning-link').on("click", function(){
      //select the sync tab,
    ...
    $('#sync-stop').on("click", function(){
      Lazarus.Options.stopSyncing();
    });

    $('#sync-login').on("click", function(){
      //hide any warning
    ...
    $('#sync-reset-password-link').on("click", function(){
    ...
    $('#sync-create-account').on("click", function(){
      //hide any warning
      $('.sync-login-warning').hide();
